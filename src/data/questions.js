...
export const QUESTIONS = {
  ...
  weightloss: {
    ...
    icon: '⚖️',
    color: '#0A9B8C',
    intro: 'Whether you\'re trying to lose 5 or 50+ pounds, the right treatment combined with lifestyle changes can make a real difference. Let\'s get started.',
    steps: [
      {
        id: 'health',
        title: 'Your Health Background',
      ...
      },
      {
        ...
        icon: '📋',
        questions: [
          { id: 'prior_contrave', type: 'radio', label: 'Have you taken Contrave in the past?', required: true, options: ['Yes, currently taking it', 'Yes, over 3 months ago', 'Never'] },
          {
            id: 'contrave_understanding_1',
            type: 'acknowledgment',
            label: 'I understand that taking Contrave is contraindicated with: Wellbutrin, Venlafaxine (Effexor), Citalopram (Celexa), Fluoxetine (Prozac), Sertraline (Zoloft), Aplenzin, or Zyban.',
            required: true,
          },
          {
            id: 'contrave_understanding_2',
            type: 'acknowledgment',
            label: 'I understand that Contrave is unsafe during abrupt discontinuation of alcohol, benzodiazepines, barbiturates, antiepileptic drugs, or within 14 days of taking MAOIs.',
            required: true,
          },
          {
            id: 'contrave_understanding_3',
            type: 'acknowledgment',
            label: 'I understand that Contrave is contraindicated with uncontrolled hypertension, pregnancy, seizure disorders, anorexia/bulimia, opioid use, or other bupropion-containing products.',
            required: true,
          },
          { id: 'seizure_meds', type: 'radio', label: 'Do you take medications for seizures or benzodiazepines such as Xanax or Lorazepam?', required: true, options: ['Yes', 'No'] },
        ],
      },
      {
        id: 'prescription',
        ...
        questions: [
          {
            id: 'prescription_option',
            type: 'radio',
            label: 'Select your prescription plan:',
            required: true,
            options: ['1-month prescription ($39.99)', '1-month prescription with 2 refills ($69.99)', '1-month prescription with 4 refills ($119.99)'],
          },
        ],
      },
      PATIENT_INFO_STEP,
